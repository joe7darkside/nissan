...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbars-rs-factory">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="/"><i class="fa fa-user" aria-hidden="true">&nbsp;</i>About
                                Us</a>
                        </li>
                        <!--Drop Menu -->
    ...
    <div class="all-page-title page-breadcrumb1">
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-12">
                    <h1>POLYESTER STAPLE FIBER (PSF)</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul class="list-inline f-social">
                        <li class="list-inline-item"><a href="/psf"><i class="fa fa-home"
                                    aria-hidden="true">&nbsp;</i>Home</a>&nbsp;
                        </li>
                        <br>
                        <li class="list-inline-item"><a href="/psf"><i class="fa fa-user"
