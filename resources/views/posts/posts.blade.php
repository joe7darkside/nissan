            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-4"> <a href="/postsPanel/create">
                                <button type="button" class="btn btn-success search-box">Create post</button>
                            </a>
                            <a href="/">
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr>
                                ...
                                <td>
                                    {{-- <div class="col-sm-10"> <a href="{{ route('postPanel.edit', $post->id) }}">
                                            <button type="button" class="btn btn-warning search-box">Edit </button>
                                        </a></div> --}}
                                    <div class="col-sm-10"><a>
                                            <form method="post" action="{{ route('postsPanel.destroy', $post->id) }}">
                                                @csrf
                                                @method('DELETE')
                                    ...
                                    <div class="col-sm-10">
                                        <a>
                                            <form method="get" action="{{ route('panel.show', $post->id) }}">
                                                @csrf
